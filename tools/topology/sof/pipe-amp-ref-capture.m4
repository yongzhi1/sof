...
`define(`FB_CHMAP',`0x02,0x04,0x08,0x01,0x00,0x00,0x00,0x00')'
)

ifelse(SMART_REF_CH_NUM, `4',
`define(`REF_CHMAP',`0x02,0x04,0x08,0x01,0x00,0x00,0x00,0x00')',
`define(`REF_CHMAP',`0x02,0x08,0x00,0x00,0x00,0x00,0x00,0x00')'
)
',
`
ifelse(SMART_FB_CHANNELS, `8',
